...
const ProductDetail5 = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.container}>
        <Image source={require('./../../assets/irene-kredenets-dwKiHoqqxk8-unsplash.jpg')} style={styles.image} />
        ...
        <Text style={styles.price2}>Total Number of Reviews : 2</Text>
